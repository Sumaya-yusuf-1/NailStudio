...
import { Award, Heart, Palette, Sparkles, Star, User } from "lucide-react";
...
export default function HomePage() {
  const galleryImages = [
    {
      src: "/360_F_225373952_PMgq8u6zsOllDQf6FyeXusU0eALi1RVG.jpg",
      alt: "Close-up of manicured nails with pink polish",
    },
    {
      src: "/nail-background-2560-x-1600-1bkdm1o6duwout0o.jpg",
      alt: "Soft pink nail art background",
    },
    {
      src: "/human-finger-touching-sequins-capsule-pink-background_23-2147827924.avif",
      alt: "Finger touching pink sequins with nail art",
    },
    {
      src: "/a399c1460c1ec1d5cff2d34ddb01a230.jpg",
      alt: "Stylish nail design with glossy finish",
    },
  ];
          ...
          <div className='container mx-auto grid gap-10 px-4 py-12 md:grid-cols-[1.2fr_1fr] md:items-center md:px-8 md:py-16 lg:py-20'>
            ...
            <div className='space-y-4 md:space-y-6'>
              ...
              <p className='max-w-md text-pretty text-sm text-gray-700 md:text-base'>
                Design your ideal nails with customizable shapes, colors,
                glitter, stickers and patterns. Save your favourites to the
                gallery.
              </p>
          ...
          <div className='container mx-auto px-4 md:px-8'>
            <div className='mb-12 text-center md:mb-16'>
              ...
              <p className='mx-auto max-w-2xl text-pretty text-sm text-gray-600 md:text-base'>
                Professional nail care and design services tailored to your
                style.
              </p>
            </div>
            ...
            <div className='grid gap-6 sm:grid-cols-2 md:grid-cols-3 md:gap-8'>
              <div className='space-y-4 text-center'>
                ...
                <p className='text-pretty text-sm text-gray-600 md:text-base'>
                  Choose from thousands of colors and patterns or create your
                  own unique design.
                </p>
              </div>
              ...
              <div className='space-y-4 text-center'>
                ...
                <p className='text-pretty text-sm text-gray-600 md:text-base'>
                  Add glitter, chrome, matte or glossy finishes to make your
                  nails stand out.
                </p>
              </div>
              ...
              <div className='space-y-4 text-center sm:col-span-2 md:col-span-1'>
                ...
                <p className='text-pretty text-sm text-gray-600 md:text-base'>
                  Professional nail care with attention to health and
            ...
            <div className='mx-auto grid max-w-6xl gap-6 sm:grid-cols-2 md:grid-cols-3 md:gap-8'>
              {TESTIMONIALS.map((item) => (
                ...
                >
                  ...
                  <div className='flex items-center gap-3'>
                    <div
                      className='flex h-10 w-10 items-center justify-center rounded-full bg-pink-200'
                      aria-hidden='true'
                    >
        ...
        <section className='bg-linear-to-br from-pink-300 via-pink-400 to-pink-500 py-12 md:py-20'>
          <div className='container mx-auto px-4 text-center md:px-8'>
            ...
            <p className='mx-auto mb-6 max-w-2xl text-pretty text-base text-white/90 md:mb-8 md:text-lg'>
              Join thousands of happy clients and create your perfect nail
              design today.
            </p>
